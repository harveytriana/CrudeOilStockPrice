...
using CrudeOilStockPriceML.Model;

namespace CrudeOilStockPriceML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\temp\crudeoil-price.csv";
        private static string MODEL_FILEPATH = @"C:\Users\DELLH\AppData\Local\Temp\MLVSTools\CrudeOilStockPriceML\CrudeOilStockPriceML.Model\MLModel.zip";
